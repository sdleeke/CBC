...
//        let markedHTML = bodyHTML?.markHTML(searchText: searchText, wholeWordsOnly: wholeWordsOnly, lemmas:lemmas, index: index)
//
//        return (markedHTML?.0?.replacingOccurrences(of: "<body>", with: "<body>"+headerHTML+"<br/>"),markedHTML?.1)
//    } else {
//        return bodyHTML?.markHTML(searchText: searchText, wholeWordsOnly: wholeWordsOnly, lemmas:lemmas, index: index)
//    }
//}
...
//    }
//    
//    guard var bodyString = string.stripHead.stripLinks() else {
//        return nil
//    }
//    
